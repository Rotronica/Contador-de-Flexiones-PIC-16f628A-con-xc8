...
add_executable(ContadorDeFlexiones_default_image_xEdM39fR ${ContadorDeFlexiones_default_library_list})

set_target_properties(ContadorDeFlexiones_default_image_xEdM39fR PROPERTIES
    OUTPUT_NAME "default-production"
    SUFFIX ".elf"
    ADDITIONAL_CLEAN_FILES "${output_extensions}"
    RUNTIME_OUTPUT_DIRECTORY "${ContadorDeFlexiones_default_output_dir}")
target_link_libraries(ContadorDeFlexiones_default_image_xEdM39fR PRIVATE ${ContadorDeFlexiones_default_default_XC8_FILE_TYPE_link})

# Add the link options from the rule file.
ContadorDeFlexiones_default_link_rule( ContadorDeFlexiones_default_image_xEdM39fR)
